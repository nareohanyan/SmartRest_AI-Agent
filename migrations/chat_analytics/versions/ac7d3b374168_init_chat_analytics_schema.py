...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_threads_status_created_at", "threads", ["status", "created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=32), server_default=sa.text("'started'"), nullable=False
        ),
    ...
    op.create_index(
        "ix_agent_runs_thread_created_at", "agent_runs", ["thread_id", "created_at"], unique=False
    )
    op.create_table(
        "thread_history",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_threads_history_thread_created_at",
        "thread_history",
    ...
    op.create_index(
        "ix_messages_thread_created_at", "messages", ["thread_id", "created_at"], unique=False
    )
    op.create_table(
        "feedback",
        sa.Column("id", sa.UUID(), nullable=False),
