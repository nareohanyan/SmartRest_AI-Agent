...
class PlannerLexicon:
    ...
    relative_tomorrow_terms: set[str]
    relative_yesterday_terms: set[str]
    relative_last_week_terms: set[str]
    relative_past_month_terms: set[str]
    relative_previous_month_terms: set[str]
    relative_this_month_terms: set[str]
    relative_past_30_days_terms: set[str]
    relative_this_year_terms: set[str]
    relative_last_year_terms: set[str]
