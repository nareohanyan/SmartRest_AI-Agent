...
_DIMENSIONS: tuple[DimensionDefinition, ...] = (
    ...
    DimensionDefinition(
        ...
        label="Category",
        aliases=("category", "product category", "menu category", "menu group"),
        permission_class="standard_dimension",
    ),
    DimensionDefinition(
...
_METRICS: tuple[MetricDefinition, ...] = (
    ...
    MetricDefinition(
        ...
        aliases=("gross sales", "gross revenue", "sales before discount"),
        permission_class="financial_core",
    ...
    MetricDefinition(
        ...
        aliases=("quantity sold", "items sold", "units sold", "sold quantity"),
        permission_class="operational_core",
        operational_trust=_trust(
    ...
    MetricDefinition(
        ...
        aliases=("completed orders", "finished orders"),
        permission_class="operational_core",
        operational_trust=_trust(
            source_entity="analytics.fact_orders",
            owner="data_ops",
    ...
    MetricDefinition(
        ...
        aliases=("discounted orders", "orders with discount", "promo orders"),
        permission_class="operational_core",
        operational_trust=_trust(
            source_entity="analytics.fact_orders",
            owner="data_ops",
    ...
    MetricDefinition(
        ...
        unit="count",
        allowed_dimension_ids=("branch", "source", "day", "hour", "weekday"),
        aliases=("delivery orders", "delivery count"),
        permission_class="operational_core",
        operational_trust=_trust(
            source_entity="analytics.fact_orders",
            owner="data_ops",
    ...
    MetricDefinition(
        ...
        aliases=("dine in orders", "hall orders", "in-store orders"),
        permission_class="operational_core",
        operational_trust=_trust(
            source_entity="analytics.fact_orders",
            owner="data_ops",
    ...
    MetricDefinition(
        ...
        aliases=("items per order", "units per order", "basket size"),
        permission_class="operational_core",
        formula_ast=RatioFormulaAst(
    ...
    MetricDefinition(
        ...
        unit="ratio",
        allowed_dimension_ids=("branch", "source", "day", "hour", "weekday", "cashier"),
        aliases=("discounted order share", "discounted order rate"),
        permission_class="operational_core",
        formula_ast=RatioFormulaAst(
