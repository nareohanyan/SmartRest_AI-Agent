...
_DIMENSIONS: tuple[DimensionDefinition, ...] = (
    DimensionDefinition(
        dimension_id="branch",
        label="Branch",
        aliases=("branch", "location", "restaurant", "store", "filial", "մասնաճյուղ"),
        permission_class="branch_scope",
    ),
    DimensionDefinition(
        dimension_id="source",
        label="Source",
        aliases=("source", "channel", "delivery source", "partner", "platform", "աղբյուր"),
    ...
    DimensionDefinition(
        ...
        label="Cashier",
        aliases=("cashier", "operator", "employee", "գանձապահ", "օպերատոր"),
...
_METRICS: tuple[MetricDefinition, ...] = (
    MetricDefinition(
        ...
        aliases=("sales", "net sales", "revenue", "real sales", "վաճառք", "ընդհանուր վաճառք"),
    ...
    MetricDefinition(
        ...
        description="Sales before discounts in the selected period.",
        unit="currency",
        allowed_dimension_ids=("branch", "source", "day", "hour", "weekday"),
        aliases=(
            "gross sales",
            "gross revenue",
        ...
        permission_class="financial_core",
        formula_ast=SumFormulaAst(metric_ids=["sales_total", "discount_amount"]),
        dependencies=("sales_total", "discount_amount"),
        operational_trust=_trust(
            source_entity="derived:gross_sales_total",
    ...
    MetricDefinition(
        ...
        aliases=("orders", "transactions", "պատվերներ", "գործարքներ"),
    ...
    MetricDefinition(
        ...
        label="Quantity Sold",
        metric_type=MetricType.BASE,
        description="Total quantity of sold menu items.",
        unit="count",
        allowed_dimension_ids=(
            "branch",
            "source",
        ...
        permission_class="operational_core",
        operational_trust=_trust(
            source_entity="analytics.fact_order_items",
            owner="data_ops",
            refresh_sla_minutes=15,
            max_freshness_lag_minutes=45,
            quality_checks=("item_quantity_non_negative", "order_item_links_valid"),
            null_handling_policy=NullHandlingPolicy.TREAT_AS_ZERO,
            zero_handling_policy=ZeroHandlingPolicy.ALLOW_ZERO,
            late_arrival_policy="restate_last_3_days",
        ),
    ...
    MetricDefinition(
        ...
        aliases=("completed orders", "finished orders", "ավարտված պատվերներ"),
        permission_class="operational_core",
        operational_trust=_trust(
            source_entity="analytics.fact_orders",
            owner="data_ops",
    ...
    MetricDefinition(
        metric_id="discounted_order_count",
        label="Discounted Order Count",
        metric_type=MetricType.BASE,
        description="Number of orders with a non-zero discount applied.",
        unit="count",
        ...
        operational_trust=_trust(
            ...
            refresh_sla_minutes=15,
            max_freshness_lag_minutes=45,
            quality_checks=("discounted_orders_non_negative", "discount_amount_consistent"),
            null_handling_policy=NullHandlingPolicy.TREAT_AS_ZERO,
            zero_handling_policy=ZeroHandlingPolicy.ALLOW_ZERO,
            late_arrival_policy="restate_last_3_days",
        ),
    ...
    MetricDefinition(
        ...
        aliases=("discounts", "promo discounts", "զեղչ", "զեղչեր"),
        permission_class="financial_core",
        operational_trust=_trust(
    ...
    MetricDefinition(
        metric_id="delivery_order_count",
        label="Delivery Order Count",
        metric_type=MetricType.BASE,
        description="Number of delivery channel orders.",
        unit="count",
        allowed_dimension_ids=("branch", "source", "day", "hour", "weekday"),
        aliases=("delivery orders", "delivery count", "առաքման պատվերներ"),
        permission_class="operational_core",
        operational_trust=_trust(
            source_entity="analytics.fact_orders",
            owner="data_ops",
            refresh_sla_minutes=15,
            max_freshness_lag_minutes=45,
            quality_checks=("delivery_orders_non_negative", "source_is_delivery"),
            null_handling_policy=NullHandlingPolicy.TREAT_AS_ZERO,
            zero_handling_policy=ZeroHandlingPolicy.ALLOW_ZERO,
            late_arrival_policy="restate_last_3_days",
        ),
    ...
    MetricDefinition(
        metric_id="dine_in_order_count",
        label="Dine-In Order Count",
        metric_type=MetricType.BASE,
        description="Number of dine-in orders.",
        unit="count",
        allowed_dimension_ids=("branch", "day", "hour", "weekday", "cashier"),
        aliases=("dine in orders", "hall orders", "in-store orders", "սրահի պատվերներ"),
        permission_class="operational_core",
        operational_trust=_trust(
            source_entity="analytics.fact_orders",
            owner="data_ops",
            refresh_sla_minutes=15,
            max_freshness_lag_minutes=45,
            quality_checks=("dine_in_orders_non_negative", "source_is_in_store"),
            null_handling_policy=NullHandlingPolicy.TREAT_AS_ZERO,
            zero_handling_policy=ZeroHandlingPolicy.ALLOW_ZERO,
            late_arrival_policy="restate_last_3_days",
        ),
    ...
    MetricDefinition(
        ...
        aliases=("avg check", "average order value", "aov", "միջին չեկ", "միջին պատվերի արժեք"),
        permission_class="financial_core",
    ...
    MetricDefinition(
        ...
        metric_type=MetricType.DERIVED,
        description="Average sold item quantity per completed order.",
        unit="count",
        allowed_dimension_ids=(
            "branch",
            "source",
        ...
        aliases=(
            ...
            "units per order",
            "basket size",
            "մեկ պատվերի ապրանքների քանակ",
            "միջին հատ մեկ պատվերում",
        ),
        permission_class="operational_core",
        formula_ast=RatioFormulaAst(
            numerator_metric_id="quantity_sold",
            denominator_metric_id="completed_order_count",
        ),
        dependencies=("quantity_sold", "completed_order_count"),
        operational_trust=_trust(
            source_entity="derived:items_per_order",
            owner="analytics_engine",
            refresh_sla_minutes=15,
            max_freshness_lag_minutes=45,
            quality_checks=("dependencies_available", "formula_validated"),
    ...
    MetricDefinition(
        ...
        aliases=("discount rate", "զեղչի բաժին"),
        permission_class="financial_core",
        formula_ast=RatioFormulaAst(
    ...
    MetricDefinition(
        metric_id="discounted_order_share",
        label="Discounted Order Share",
        metric_type=MetricType.DERIVED,
        description="Share of completed orders that had a discount applied.",
        unit="ratio",
        allowed_dimension_ids=("branch", "source", "day", "hour", "weekday", "cashier"),
        aliases=(
            "discounted order share",
            "discounted order rate",
            "զեղչված պատվերների բաժին",
            "զեղչով պատվերների բաժին",
        ),
        permission_class="operational_core",
        formula_ast=RatioFormulaAst(
            numerator_metric_id="discounted_order_count",
            denominator_metric_id="completed_order_count",
        ),
        dependencies=("discounted_order_count", "completed_order_count"),
        operational_trust=_trust(
            source_entity="derived:discounted_order_share",
            owner="analytics_engine",
            refresh_sla_minutes=15,
            max_freshness_lag_minutes=45,
            quality_checks=("dependencies_available", "formula_validated"),
