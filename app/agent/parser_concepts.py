...
ITEM_QUANTITY_TERMS = {
    ...
    "ամենաքիչ վաճառված",
    "ամենքիչ վաճառված",
    "ամենաքիչ վաճառք ունեցող",
    "ամենքիչ վաճառք ունեցող",
    "շատ վաճառված",
    "վաճառված",
    "քանակ",
    "самое продаваемое",
...
ITEM_REVENUE_TERMS = {
    ...
    "ամենաշատ եկամուտ",
    "ամենաքիչ եկամուտ",
    "ամենաքիչ եկամուտ բերող",
    "ամենաքիչ եկամուտ բերած",
    "եկամտաբեր",
    "եկամուտ",
    "փող",
    "փող բերել",
...
_SINGULAR_TOP_ITEM_PATTERNS = (
    ...
    "ամենաքիչ վաճառված ապրանքը",
    "ամենքիչ վաճառված ապրանքը",
    "ամենաքիչ վաճառք ունեցող ապրանքը",
    "ամենքիչ վաճառք ունեցող ապրանքը",
